...
|---|---|---|---|
| 100 รีวิว / Groq paid | ~52 วินาที | ~100-150 วินาที | **~2 นาที** |
| 100 รีวิว / Gemini paid | ~52 วินาที | ~200-300 วินาที | **~3-5 นาที** |
| 500 รีวิว / Groq paid | ~4 นาที | ~8-12 นาที | **~10 นาที** |
| 500 รีวิว / Gemini paid | ~4 นาที | ~16-25 นาที | **~20 นาที** |
| 100 รีวิว / Groq **free** | — | จริง ~3.7 นาที (throttle 2.2s/req) | **~4 นาที** |
| ต้นทุน Gemini 1.5 Flash | 0.002 บาท | ✅ (แต่ 1.5 ถูก deprecate แล้ว) | — |
| ต้นทุน Gemini **2.5 Flash** | — | ~0.012 บาท/รีวิว | **~0.01 บาท** |
| ต้นทุน Groq Llama 3.3 70B | — | ~0.013 บาท/รีวิว | **~0.01 บาท** |
| ต้นทุน **Free tier** | — | **0 บาท** | **0 บาท** |
...
**ตัวอย่างตาราง 4.3 หลังแก้:**

```
การทดสอบ                       ระบบเดิม (Manual)    ระบบใหม่ (AI, Free)    ระบบใหม่ (AI, Paid)
เวลาวิเคราะห์ 100 รีวิว         ~3.5 ชั่วโมง          ~4 นาที (Groq)          ~2 นาที (Groq)
เวลาวิเคราะห์ 500 รีวิว         ~17 ชั่วโมง           ~20 นาที (Groq)         ~10 นาที (Groq)
ต้นทุนต่อรีวิว                  ~2.5 บาท (ค่าแรง)    0 บาท                   ~0.01 บาท
การลดเวลา (Groq free)           —                     ลดลง ~98.1%             ลดลง ~99.1%
```
